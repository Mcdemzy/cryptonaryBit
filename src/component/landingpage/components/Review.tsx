    ...
    <>
      ...
      <aside className="flex flex-col md:flex-row flex-wrap gap-y-6 justify-between items-center">
        ...
        <section className="w-full md:w-[400px] py-4 p-3 rounded-md shadow-lg">
          ...
          <div className="border-b flex justify-start items-center gap-x-3">
            ...
            <div className="mt-2">
              ...
              <h1 className="flex justify-start items-center gap-x-3">
                1 review
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="w-4 h-4 bi bi-geo-alt"
                  viewBox="0 0 16 16"
                >
              ...
              <h2 className="cursor-pointer flex justify-start items-center gap-x-2">
                <span>
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="w-4 h-4 bi bi-hand-thumbs-up"
                    viewBox="0 0 16 16"
                  >
        ...
        <section className="w-full md:w-[400px] py-4 p-3 rounded-md shadow-lg">
          ...
          <p>
            As expected, CryptonaryBit one of the best if not the best among the
            trusted prop firm. They are honest and committed to traders, made my
            payout very smoothly and looking for long success with them.
          </p>
          <h1 className="border-b py-3">
            Date of experience: <span></span>Jun 10, 2024
          </h1>
          <div className="mt-6 flex jusity-start items-center">
            <div className="flex justify-start items-center gap-x-3">
              <h2 className="cursor-pointer flex justify-start items-center gap-x-2">
        ...
        <section className="w-full md:w-[400px] py-4 p-3 rounded-md shadow-lg">
          ...
          <h1 className="mt-4 font-bold text-lg">
            10/10 Score with CryptonaryBit
          </h1>
          <p>
