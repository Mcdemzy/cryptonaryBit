            ...
            <div className="mx-auto max-w-3xl mt-8">
              <div className="divide-y divide-gray-100 space-y-4">
                <details className="group bg-yellow-200 rounded-md px-3" open>
                  ...
                  <div className="pb-4 text-secondary-500">
                    CryptonaryBit Pro is your gateway to mastering the crypto
                ...
                <details className="group bg-yellow-200 rounded-md px-3">
                  ...
                  <div className="pb-4 text-secondary-500">
                    ...
                    at support@cryptonaryBit.com. If possible, please include
                    the email you used and the correct email you intended to
                    use. Our support team will help update your account with the
                    right information.
                  </div>
                </details>
              </div>
          ...
          <aside>
            <div className="mx-auto max-w-3xl mt-8">
              ...
              <div className="text-center mt-6">
                ...
                <p className="mt-6">
                  © 2024 CryptonaryBit. All rights reserved.
                </p>
              </div>
            </div>
          </aside>
